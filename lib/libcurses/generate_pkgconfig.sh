...
#
# Generate pkg-config files for ncurces
...
Name: form
Description: curses extension for programming forms
Version: ${lib_version}
Requires: 
Libs: -L\${libdir} -lform
Cflags: -I\${includedir}
...
Name: menu
Description: curses extension for programming menus
Version: ${lib_version}
Requires: 
Libs: -L\${libdir} -lmenu
Cflags: -I\${includedir}
...
Name: panel
Description: panel stack extension for curses
Version: ${lib_version}
Requires: 
