...
#define BIGFIVE_IS_ESCAPE_FREE 0
...
#define CPLUS_INCLUDE_DIR1 "/usr/include/c++/4.6.2"

/* Define compiler-specific C++ include directory 2. */
#define CPLUS_INCLUDE_DIR2 "/usr/include/c++/4.6.2/x86_64-unknown-bitrig0.1"

/* Define compiler-specific C++ include directory 3. */
#define CPLUS_INCLUDE_DIR3 "/usr/include/c++/4.6.2/backward"
...
/* Define compiler-specific C include directory 1. */
#define C_INCLUDE_DIR1 "/usr/include"
