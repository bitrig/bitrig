...
expect EINVAL -u 65534 -g 65534 open ${n1} O_RDONLY,O_TRUNC
expect EACCES -u 65534 -g 65534 open ${n1} O_WRONLY,O_TRUNC
expect 0 -u 65534 -g 65534 chmod ${n1} 0747
expect EINVAL -u 65533 -g 65534 open ${n1} O_RDONLY,O_TRUNC
expect EACCES -u 65533 -g 65534 open ${n1} O_WRONLY,O_TRUNC
expect 0 -u 65534 -g 65534 chmod ${n1} 0774
expect EINVAL -u 65533 -g 65533 open ${n1} O_RDONLY,O_TRUNC
expect EACCES -u 65533 -g 65533 open ${n1} O_WRONLY,O_TRUNC
