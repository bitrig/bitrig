 ...
 */
#ifndef __MACHINE_FDT_H__
#define __MACHINE_FDT_H__
...
int	fdt_get_interrupt(void *, int *);
...
void 	*fdt_find_node_with_prop(void *node, char *propname);
