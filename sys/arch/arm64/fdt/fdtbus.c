...
#define _ARM64_BUS_DMA_PRIVATE
#include <machine/bus.h>
#include <machine/fdt.h>

#include <arm64/fdt/fdtbusvar.h>

/* FIXME: use own attach args */
#include <arm64/arm64/arm64var.h>

struct machine_bus_dma_tag fdt_bus_dma_tag = {
	NULL,
	_dmamap_create,
	_dmamap_destroy,
	_dmamap_load,
...
struct cfattach fdt_ca = {
	sizeof(struct device), fdt_match, fdt_attach, NULL,
